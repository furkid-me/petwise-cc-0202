...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      {/* 頂部區塊 */}
      <div className="bg-gradient-to-br from-violet-500 via-indigo-600 to-indigo-700 text-white p-4 pb-16 relative">
      ...
      {/* 寵物當前狀態卡片 */}
      <div className="-mt-8 mx-4 bg-white rounded-xl ring-1 ring-gray-950/10 p-4 mb-4">
      ...
      {/* 今日飲食記錄列表 */}
      <div className="mx-4 bg-white rounded-xl ring-1 ring-gray-950/10 p-4 mb-20 flex-1">
        <div className="flex justify-between items-center mb-3">
      ...
      <button
        onClick={() => router.push('/diary/new')}
        className="fixed bottom-20 right-4 bg-gray-950 text-white rounded-full w-14 h-14 flex items-center justify-center shadow-xl hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500"
        aria-label="新增飲食記錄"
      >
