  ...
  try {
    ...
    const newDietRecord = await prisma.dietRecord.create({
      data: {
        ...
        calculatedCalories: calculatedCalories != null ? parseFloat(calculatedCalories) : null,
        calculatedProtein: calculatedProtein != null ? parseFloat(calculatedProtein) : null,
        calculatedFat: calculatedFat != null ? parseFloat(calculatedFat) : null,
